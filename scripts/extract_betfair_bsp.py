...
# Month optional (malformed "Newton Abbot 16th"); leading space optional too
# (older data fuses them: "Cork1st Oct" -> "Cork"). No course name ends in a
# digit+ordinal, so this is safe.
